    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto animate-slide-up">
          ...
          {/* Main Heading */}
<h1 className="font-bold bg-gradient-hero bg-clip-text text-transparent mb-6 leading-tight">
  <span className="block text-6xl md:text-8xl">Bharat</span>
  <span className="block text-3xl md:text-5xl text-accent">Quest</span>
</h1>
